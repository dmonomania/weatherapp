...
fetch('https://dmonomania.github.io/weatherapp/cities.json')
  .then((response) => response.json())
  .then((data) => (cities = data));

fetch('https://dmonomania.github.io/weatherapp/countries.json')
  .then((response) => response.json())
